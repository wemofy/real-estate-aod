...
const HeaderText = ({headerText, headerText2,headerText3,emailText}) => {
    ...
    <span className="absolute px-3 font-medium text-base-100 -translate-x-1/2 bg-primary left-1/2 dark:text-white dark:bg-gray-900 rounded-full"><BsFillBuildingsFill className="text-xl my-2 " />
</span>
</div>
